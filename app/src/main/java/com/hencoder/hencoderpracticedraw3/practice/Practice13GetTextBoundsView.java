...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float textHeight = Math.abs(bounds.bottom - bounds.top);
        int middle = (int) ((top + bottom) / 2 + textHeight / 2);
        ...
        float text5Height = Math.abs(bounds.bottom - bounds.top);
        middle = (int) ((top + bottom) / 2 + text5Height / 2);
